...
#define SYSEN  0x01
#define RC256K 0x18
#define BIAS   0x29//选中COM为4个公共口   0x01  选择了1/3偏压
#define LCDON  0x03
#define SYSDIS 0x00
#define WDTDIS 0x05
...
#define   PinHigh_WR     HAL_GPIO_WritePin(GPIOB,GPIO_PIN_1,GPIO_PIN_SET);//将CS引脚电平拉高
#define   PinLow_WR      HAL_GPIO_WritePin(GPIOB,GPIO_PIN_1,GPIO_PIN_RESET);     //将CS引脚电平拉低

#define   PinHigh_Data   HAL_GPIO_WritePin(GPIOB,GPIO_PIN_0,GPIO_PIN_SET);//将CS引脚电平拉高
#define   PinLow_Data    HAL_GPIO_WritePin(GPIOB,GPIO_PIN_0,GPIO_PIN_RESET);     //将CS引脚电平拉低

#define   PinHigh_CS     HAL_GPIO_WritePin(GPIOB,GPIO_PIN_2,GPIO_PIN_SET);//将CS引脚电平拉高
#define   PinLow_CS      HAL_GPIO_WritePin(GPIOB,GPIO_PIN_2,GPIO_PIN_RESET);     //将CS引脚电平拉低
